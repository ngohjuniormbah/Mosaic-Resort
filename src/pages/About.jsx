...
const TEAM = [
  {
    ...
    bio: "Leads overall strategy, team coordination and project delivery.",
  },
  {
    avatar: IMAGES.avatar1,
    name: "Brice Tchoueke",
    role: "Business Analyst",
    bio: "Handles market research, financial projections and feasibility analysis.",
  },
  {
    avatar: IMAGES.avatar2,
    name: "Sandrine Mballa",
    role: "UI/UX Designer",
    bio: "Designs the digital experience and brand visual identity.",
  },
  {
    avatar: IMAGES.avatar3,
    name: "Kevin Nganou",
    role: "Marketing Lead",
    bio: "Drives brand storytelling, content strategy, and outreach.",
  },
  {
    avatar: IMAGES.avatar4,
    name: "Carine Djomo",
    role: "Operations Lead",
    bio: "Oversees logistics, community partnerships, and service delivery.",
  },
];
